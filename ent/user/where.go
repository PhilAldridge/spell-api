...
func HasSchoolsWith(preds ...predicate.School) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSchoolsStep()
...
// HasOwnedSchool applies the HasEdge predicate on the "owned_school" edge.
func HasOwnedSchool() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasOwnedSchoolWith applies the HasEdge predicate on the "owned_school" edge with a given conditions (other predicates).
func HasOwnedSchoolWith(preds ...predicate.School) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newOwnedSchoolStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasResults() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasResultsWith(preds ...predicate.Result) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newResultsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
